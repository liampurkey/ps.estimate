#This script implements the propensity score estimation algorithm presented in 
#Matching Methods in Practice: Three Examples (Imbens 2014). Intuitively, 
#the algorithm approximates the propensity score using a quadratic model where 
#variables are selectively included or excluded using likelihood ratio tests.
